 ...
 public:
	...
	static void classInit(int sample_rate) {
	 ...
	 void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
		...
		float fSlow5 = (0.00100000005f * fSlow4);
		float fSlow6 = (0.00100000005f * ((0.0f - (2.0f * fSlow1)) / fSlow3));
		float fSlow7 = (0.00100000005f * ((1.0f - fSlow2) / fSlow3));
		float fSlow8 = (0.000500000024f * fSlow4);
		for (int i = 0; (i < count); i = (i + 1)) {
			fRec0[0] = (fSlow5 + (0.999000013f * fRec0[1]));
			fRec2[0] = (fSlow6 + (0.999000013f * fRec2[1]));
			fRec3[0] = (fSlow7 + (0.999000013f * fRec3[1]));
			fRec1[0] = (float(input0[i]) - ((fRec2[0] * fRec1[1]) + (fRec3[0] * fRec1[2])));
			fRec4[0] = (fSlow8 + (0.999000013f * fRec4[1]));
			output0[i] = FAUSTFLOAT(((fRec0[0] * fRec1[1]) + (fRec4[0] * (fRec1[0] + fRec1[2]))));
			fRec5[0] = (float(input1[i]) - ((fRec2[0] * fRec5[1]) + (fRec3[0] * fRec5[2])));
